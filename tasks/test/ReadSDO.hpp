...
#ifndef CANOPEN_MASTER__TEST_READSDO_TASK_HPP
#define CANOPEN_MASTER__TEST_READSDO_TASK_HPP

#include "canopen_master/test/ReadSDOBase.hpp"
...
namespace test{
     ...
     * prefix argument.
     */
    class ReadSDO : public ReadSDOBase
    {
        friend class ReadSDOBase;
    protected:
        StateMachine* m_state_machine = nullptr;

    public:
        /** TaskContext constructor for ReadSDO
         ...
         */
        ReadSDO(std::string const& name = "canopen_master::test::ReadSDO");

        /** Default destructor of ReadSDO
         */
        ~ReadSDO();
