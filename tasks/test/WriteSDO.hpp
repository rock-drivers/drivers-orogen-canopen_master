...
#ifndef CANOPEN_MASTER__TEST_WRITESDO_TASK_HPP
#define CANOPEN_MASTER__TEST_WRITESDO_TASK_HPP

#include "canopen_master/test/WriteSDOBase.hpp"
...
namespace test{
     ...
     *     task('custom_task_name','canopen_master::ReadSDO')
     * end
     * \endverbatim
     * It can be dynamically adapted when the deployment is called with a
     * prefix argument.
     */
    class WriteSDO : public WriteSDOBase
    {
        friend class WriteSDOBase;
    protected:
        StateMachine* m_state_machine = nullptr;

    public:
        /** TaskContext constructor for WriteSDO
         * \param name Name of the task. This name needs to be unique to make it identifiable via nameservices.
         * \param initial_state The initial TaskState of the TaskContext. Default is Stopped state.
         */
        WriteSDO(std::string const& name = "canopen_master::test::WriteSDO");

        /** Default deconstructor of WriteSDO
         */
	~WriteSDO();
